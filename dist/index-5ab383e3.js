...
const Om = Em(), [gd, u3] = fn("ConfigProvider"), Dm = Ko(() => Y()), km = Ko(() => Y(0));
function yd(e) {
  const t = gd({
    scrollBody: Y(!0)
  }), n = km(), r = Dm(), a = Y(e), o = () => {
...
}, [c3, bh] = fn("PopperContent"), Pd = /* @__PURE__ */ fe({
  inheritAttrs: !1,
...
const [_h, f3] = fn(["MenuRoot", "MenuSub"], "MenuContext"), [wh, p3] = fn("MenuRoot"), Eh = "rovingFocusGroup.onEntryFocus", Oh = { bubbles: !1, cancelable: !0 };
function Dh(e) {
  const t = document.activeElement;
  for (const n of e)
    if (n === t || (n.focus(), document.activeElement !== t))
...
const [v3, kh] = fn("RovingFocusGroup"), $h = /* @__PURE__ */ fe({
...
const fM = {
  ...
  setup(e) {
    const t = e, n = yv(
      () => import("./index-8238d693.js").then((i) => i[t.icon])
    ), r = Y(!1);
    Yt(() => {
      r.value = !0;
    });
...
}), JF = ["onSubmit"], QF = { class: "space-y-1" }, e3 = {
  key: 0,
  class: "text-red-1"
}, t3 = 100, n3 = /* @__PURE__ */ fe({
  ...
  setup(e, { expose: t, emit: n }) {
    ...
    return qt("lockScroll", u), t({
      ...
      $("form", {
        ...
        se(h8),
        se(GF),
        m(s).length ? (O(), A("span", e3, "資料未填寫完整")) : Z("", !0),
        $("button", {
          ref_key: "submitBtn",
          ref: c,
...
const r3 = /* @__PURE__ */ Ba(n3, [["__scopeId", "data-v-10573d3c"]]);
function h3(e) {
  if (!e)
    return "";
  const { t } = _r.global;
...
const a3 = (e) => {
  e.component("TCEventEditorApp", r3);
}, y3 = {
  install: a3
};
export {
