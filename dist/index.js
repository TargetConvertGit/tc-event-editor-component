import { defineComponent as h, ref as g, watch as N, openBlock as n, createElementBlock as o, createElementVNode as r, withDirectives as b, Fragment as f, renderList as x, unref as m, toDisplayString as _, createCommentVNode as S, vModelSelect as E, computed as U, vModelText as $, createVNode as C } from "vue";
class F {
  // 取得列舉索引
  getEnumKey(l, e) {
    return l[e];
...
const st = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(t, { emit: l }) {
    const e = t, u = g(0);
    e.interval == 1 && (u.value = e.frequency), N(u, (c) => {
      i[c] && (l("update:frequency", c), l("update:interval", 1), d.value = u.value);
    });
    const d = g(e.frequency);
    return N(d, (c) => l("update:frequency", c)), (c, a) => (n(), o("div", H, [
      r("div", K, [
        r("label", z, [
          Q,
          b(r("select", {
            ...
            (n(!0), o(f, null, x(m(i), (s, v) => (n(), o(f, { key: v }, [
              Number.isInteger(s) ? (n(), o("option", {
                key: 0,
                value: s
              }, _(v), 9, X)) : S("", !0)
            ], 64))), 128)),
      ...
      m(i)[u.value] == null ? (n(), o("div", O, [
        r("label", A, [
          ...
          b(r("select", {
            ...
            (n(!0), o(f, null, x(m(i), (s, v) => (n(), o(f, { key: v }, [
              s != m(i).Never && Number.isInteger(s) ? (n(), o("option", {
                key: 0,
                value: s
              }, _(v), 9, D)) : S("", !0)
            ], 64))), 128))
  ...
  emits: ["update:data"],
  setup(t, { emit: l }) {
    const e = t, u = U(() => JSON.parse(e.data || "{}")), d = () => l("update:data", JSON.stringify(u.value, null, 4));
    return (c, a) => e.data ? (n(), o("div", y, [
      T,
      r("pre", null, [
